...
<script
	src="${pageContext.request.contextPath}/JavaScript/popupLöschen.js"
	defer></script>
</head>
<body>
	...
	<script>
		...
		function hideLogoutMessage() {
			var logoutMessageElement = document
					.getElementById("logout-message");
		...
		<div class="login-form">
			...
			<form action="${pageContext.request.contextPath}/LoginServlet"
				...
				<div class="form-group">
					...
					%>
					<%
					// Prüfe, ob die Session-Variable logoutMessage gesetzt ist und nicht leer ist
					if (session.getAttribute("logoutMessage") != null && !session.getAttribute("logoutMessage").toString().isEmpty()) {
					%>
					<div id="logout-message"><%=session.getAttribute("logoutMessage")%></div>
					<%
					// Lösche die Session-Variable logoutMessage
