...
<script
	src="${pageContext.request.contextPath}/JavaScript/navigation_extended2.js"></script>
<script
	src="${pageContext.request.contextPath}/JavaScript/navigation.js"></script>
...
.pin-input-container::after {
	...
	/* Pseudo-Element für das visuelle Feedback */
	position: absolute;
	top: 50%;
