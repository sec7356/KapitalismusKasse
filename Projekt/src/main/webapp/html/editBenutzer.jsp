...
<div class="transaktionen">
        ...
        <form action="${pageContext.request.contextPath}/EditBenutzerServlet" method="post">
            <table class="transaktionen-table">
                ...
                <tbody>
                    <tr>
                        <td><input type="text" id="vorname" name="vorname" value="${empty benutzer ? '' : benutzer.vorname}" required></td>
                        <td><input type="text" id="nachname" name="nachname" value="${empty benutzer ? '' : benutzer.nachname}" required></td>
                        <td>${empty benutzer ? '' : benutzer.email}</td>
                        <td><input type="text" id="pin" name="pin" value="${empty benutzer ? '' : benutzer.pin}" required></td>
                        <td>
