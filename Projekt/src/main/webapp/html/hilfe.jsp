...
<body>
    ...
    <nav>
        <ul>
            <li><a href="${pageContext.request.contextPath}/html/Banking-Login.jsp" class="white-anchor">Zurück zum Login</a></li>
            <li><a href="${pageContext.request.contextPath}/html/kontakt.jsp" class="white-anchor">Kontakt</a></li>
        </ul>
    </nav>
