...
<body>
	...
	<div class="geldHintergrund">
		<div class="internForm">
			<form method="post" action="${pageContext.request.contextPath}/UeberweisenServlet">
				<fieldset>
					...
					<div>
						<label for="nach">Nach:</label> <input type="text" id="nach" name="nach" required maxlength="34"><br>
					</div>
					<div>
