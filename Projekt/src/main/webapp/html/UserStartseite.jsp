...
<nav id="navbar">
    <ul>
        ...
        <li><a href="${pageContext.request.contextPath}/html/UserStartseite.jsp" class="active" title="Sehen Sie sich Ihr Dashboard an!">Startseite</a></li>
...
<div class="grauBackground">
    ...
    <div class="profile-box">
        ...
        <div class="profile-text">
            <p id="greeting">Guten Tag, <span id="vorname"><%= session.getAttribute("vorname") %></span> <span id="nachname"><%= session.getAttribute("nachname") %></span>!</p>
        </div>
    </div>  
        <div class="kontoinformationen">
        	<p id="kontostand"> Saldo: <%= session.getAttribute("kontostand") + " €"%></p>
        	<p id="iban">IBAN: <%= session.getAttribute("IBAN") %></p>
    </div>
    	<div class="kontoinformationen">
    		<p id="disporahmen"> Disporahmen: 500.0 €</p>	 <!--	Funktion fehlt nocht   -->
...
<div class="verlinkungen">
   ...
   <p>Was möchten Sie machen?</p><br>
   <div class="aktion">
        <a href="${pageContext.request.contextPath}/html/Ueberweisungen.jsp">Geld überweisen</a> </div>
    <div class="aktion">
        <a href="${pageContext.request.contextPath}/html/verlauf.jsp">Buchungsverlauf ansehen</a> </div>
    <div class="aktion">
        <a href="${pageContext.request.contextPath}/html/Kontoauszuege.jsp">Kontoauszüge ansehen</a> </div>
</div>
</div>
</div>
