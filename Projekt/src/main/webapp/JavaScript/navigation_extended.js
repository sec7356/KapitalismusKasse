window.addEventListener("scroll", function() {
    ...
    if (window.scrollY > 0) {
        ...
        nav.style.transition = "height 0.3s ease-in-out";
        nav.style.height = smallNavHeight + "px";
        
        // Bild verkleinern und rechtsbündig positionieren Logo
        ...
        image.style.right = "10px"; // Positioniere rechts
        ...
        // Konto-Bild verkleinern und rechtsbündig positionieren AccountBild
